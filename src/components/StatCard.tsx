      ...
      <Card className="shadow-sm shadow-gray-500 rounded-lg h-[100px]">
        <CardContent className="dark:bg-[#1A2D26]">
          <div className="flex justify-between items-center ">
            <p className="text-[#758DA3] dark:text-[#C3C3C3] text-sm">
              {label}
            </p>

            {icon === "IoPeople" && (
              <div className="w-10 h-10 flex items-center justify-center bg-[#F4F8FC] dark:bg-[#173437] rounded">
          ...
          <h2 className="text-2xl font-bold text-[#00274D] dark:text-[#E8EAE9]">
            {value}
          </h2>
        </CardContent>
      </Card>
