...
interface AddInternModalProps {
  open: boolean;
  onClose: () => void;
  onAdd: (intern: InternData) => Promise<void> | void;
}
...
export default function AddInternModal({ open, onClose, onAdd }: AddInternModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const internData: InternData = {
        ...
        email: formData.email.trim().toLowerCase(), // Automatically Normalize email to lowercase
      };
