describe('template spec', () => {
  ...
  it('passes', () => {
    ...
    cy.get('.text-\\[var\\(--primary-color\\)\\]').should('have.text', 'Attendance');
  ...
  it('Shows the export button', () => {
    ...
    cy.get('.MuiTableHead-root > .MuiTableRow-root > :nth-child(5)').should('be.visible')
   ...
   it('Shows the table data', () => {
    ...
    cy.get('td').eq(2).should('cantain.text', '	4:50 Pm')
})
